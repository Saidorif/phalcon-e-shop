...
class Products extends Model
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('brand_id', 'Products\Model\Brand', 'id', [
            'alias' => 'brand'
        ]);
    }
    ...
    public function getSaleDate($format = 'Y-m-d H:i:s')
    {
        if ($format) {
            if ($this->sale_ends) {
                return date($format, strtotime($this->sale_ends));
            }
        } else {
            return $this->sale_ends;
        }
    }
    ...
    public function updateFields($data)
    {
        ...
        $this->is_new = isset($data['is_new']) ? 1 : 0;
        $this->is_sale = isset($data['is_sale']) ? 1 : 0;
        $this->in_stock = isset($data['in_stock']) ? 1 : 0;
