              ...
              <div class="product product-single">
                <div class="product-thumb">
                  <div class="product-label">
                    ...
                    {% if item.is_sale %}<span class="sale">-20%</span>{% endif %}
                  </div>
                ...
                <div class="product-body">
                  <h3 class="product-price">${{ item.getPrice() }} <del class="product-old-price">${{ item.getPrice() + 13 }}</del></h3>                  <div class="product-rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                  ...
                  <h2 class="product-name"><a href="#">{{ item.getTitle() }}</a></h2>
