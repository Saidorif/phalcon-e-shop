...
<div class="ui segment">
    ...
    <a href="{{ url.get() }}products/category" class="ui button teal">
        <i class="icon list"></i> {{ helper.at('Category') }}
    </a>

    <a href="{{ url.get() }}products/brand" class="ui button secondary">
        <i class="icon list"></i> {{ helper.at('Brand') }}
    </a>
    <a href="{{ url.get() }}products/notification" class="ui button secondary">
        <i class="icon list"></i> Уведомление
    </a>
