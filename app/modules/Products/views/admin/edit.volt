    ...
    <div class="ui segment">
        <div class="ui grid">
            <div class="ten wide column">
                ...
                {{ form.renderDecorated('sale_ends') }}                
                {{ form.renderDecorated('category_id') }}
                {{ form.renderDecorated('brand_id') }}
            ...
            <div class="six wide column gallery-half">
                ...
                {{ form.renderDecorated('sale_amount') }}
                {{ form.renderDecorated('is_new') }}
                {{ form.renderDecorated('is_sale') }}
                {{ form.renderDecorated('special_offer') }}
                {{ form.renderDecorated('index_page') }}
                {{ form.renderDecorated('in_stock') }}
            </div>
